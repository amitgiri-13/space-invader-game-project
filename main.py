...
#title and icon
pygame.display.set_caption("kill EXO enemy")
icon = pygame.image.load('ufo.png')
pygame.display.set_icon(icon)

#start of the game 
start_image = pygame.image.load('play.jpg')
start_font = pygame.font.Font('freesansbold.ttf',100)
start_x = 0
start_y = 0
start = False
#end of the game 
end_image = pygame.image.load('playagain.jpg')
end_x = 0
end_y = 0
end = False
gameover = False
    ...
    for event in pygame.event.get():
        ...
        if event.type==pygame.KEYDOWN:
            if event.key==pygame.K_SPACE and gameover:
                ...
                #initial score
                score_value = 0
                restart_sound = mixer.Sound('restart.wav')
                restart_sound.play()
